...
namespace AccessManagement.Libraries
{
    public class Email
    {
                ...
                <body>
                    ...
                    <main>
                        <div align='center'>
                            ...
                            <p>E-mail enviado automaticamente por Gestão de Acessos.</p>
                        </div>
                    </main>
                </body>";

            MailMessage msg = CreateMessageBody(user.Email, "Gestão de Acessos - Gerar Nova Senha", message, true);
        ...
        public void SendRegistrationConfirmation(User user, string url)
        {
            ...
            MailMessage msg = CreateMessageBody(user.Email, "Gestão de Acessos - Confirmação de Cadastro", message, true);
